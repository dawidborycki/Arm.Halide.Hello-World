#ifndef HALIDE__blur_threshold_android_h
#define HALIDE__blur_threshold_android_h
#include <stdint.h>
...
int blur_threshold(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_thresholded_buffer);

HALIDE_FUNCTION_ATTRS
int blur_threshold_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *blur_threshold_metadata();
